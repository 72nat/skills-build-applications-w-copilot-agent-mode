...
class ModelTests(TestCase):
    def setUp(self):
        ...
        self.activity = Activity.objects.create(user=self.user, type='Test Activity', duration=10, date='2026-03-04')
    ...
    def test_activity_str(self):
        self.assertEqual(str(self.activity), 'Test User - Test Activity')

    def test_leaderboard_str(self):
        self.assertEqual(str(self.leaderboard), 'Test Team - 50')
